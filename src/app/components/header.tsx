...
import {OpenDialogContext} from '../dialog';
        ...
        <Toolbar>
          <ToolbarRow>
            <ToolbarSection alignStart>
              <ToolbarTitle>Dungeon Degenerates Companion App</ToolbarTitle>
            </ToolbarSection>
            <ToolbarSection alignEnd>
              <ToolbarIcon
                onClick={() => openDialog('LAJ!', GeneralInfo)}
                use={
                  <svg
              ...
              <ToolbarIcon
                tag="a"
                href="https://github.com/krawaller/ddcomp"
                target="_blank"
                use={
                  <svg
                    style={{ width: "24px", height: "24px" }}
